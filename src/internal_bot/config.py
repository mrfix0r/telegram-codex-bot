...
class AppConfig:
    ...
    def from_env(cls, base_dir: Path | None = None) -> "AppConfig":
        ...
        return cls(
            ...
            actions_file=resolve_path("BOT_ACTIONS_FILE", "./actions.json"),
            workspace_root=resolve_path("BOT_WORKSPACE_ROOT", "."),
            ...
            timezone=os.environ.get("BOT_TIMEZONE", "Europe/Moscow"),
        )
